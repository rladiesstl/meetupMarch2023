...
xfun::embed_files(c("Pew Research Center Global Attitudes Spring 2019 Dataset WEB.sav", "01_Reproducible_reports_AK_210323_completed.Rmd", "Pew Research Center 2019 Global Attitudes Survey WEB .docx"), text= "Click here for data, codebook, and code file")


# IF INCLUDING .BIB OR STYLE REF - embed these as well!
# xfun::embed_files(c("Pew Research Center Global Attitudes Spring 2019 Dataset WEB.sav", "01_Reproducible_reports_AK_210323_completed.Rmd", "Pew Research Center 2019 Global Attitudes Survey WEB .docx", "references.bib", "word-style-ref.docx"), text= "Click here for data, codebook, and code file (and references.bib and Word style ref!)")
```
...
```{r hist-age, echo=FALSE, message=FALSE, warning=FALSE, fig.alt="Histograms of survey participant age by country. Shows four plots, one for each country. All plots are right skewed."}
